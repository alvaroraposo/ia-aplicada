...
export default async function main(game) {
  ...
  //Worker - Thread separada para excutar o projeto
  ...
  //PIXI.JS - Executa Canvas
  //Um print da tela é tirado a cada 200ms!!
  //Thread (worker) vai processar dados do print
  //Thread principal nunca processa nada.
  //Thread secundária termina e atualiza a tela, disparando evento
  //Seguimos para machine-learning/worker.js
  setInterval(async () => {
