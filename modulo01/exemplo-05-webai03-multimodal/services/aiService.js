export class AIService {
  ...
  async checkRequirements() {
    const errors = [];
    //checar dependências, se navegador está correto, se modelo foi baixado, etc.
    // @ts-ignore
    ...
    // Check Translator availability - API de Tradução.
    // Prompt funciona em PT, mas tradução do multimodal, somente em EN
